...
every part, reflow SMD). If you'd rather wire up dev modules with
jumper cables — no PCB fab, no SMD reflow — see
[DIY from modules](./diy-modules).
:::
